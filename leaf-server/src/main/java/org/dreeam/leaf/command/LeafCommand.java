...
import org.dreeam.leaf.command.subcommands.CounterCommand;
...
public final class LeafCommand extends Command {
    ...
    private static final LeafSubcommand COUNTER_SUBCOMMAND = new CounterCommand();
    private static final Map<String, LeafSubcommand> SUBCOMMANDS = Util.make(() -> {
        ...
        commands.put(Set.of(CounterCommand.LITERAL_ARGUMENT), COUNTER_SUBCOMMAND);
