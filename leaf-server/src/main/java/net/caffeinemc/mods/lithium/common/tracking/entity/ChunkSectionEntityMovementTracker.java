...
public abstract class ChunkSectionEntityMovementTracker {
    ...
    public static void unregister(ChunkSectionEntityMovementTracker @NotNull [] trackers) { // Leaf - Replace Lithium tracker list with with optimized collection
    ...
    public static boolean isUnchangedSince(long lastCheckedTime, ChunkSectionEntityMovementTracker @NotNull [] trackers) { // Leaf - Replace Lithium tracker list with with optimized collection
        for (ChunkSectionEntityMovementTracker tracker : trackers) {
